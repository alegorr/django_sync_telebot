...
SECRET_KEY = 'cpMc1yf3jucvj5/hIaW47xRFI8VemFxT3iAkxKHqoFA='
...
WEBHOOK_HOST = 'deeppavlov1.herokuapp.com'
...
try:
    TELEBOT_KNOWN_SERVICES = zip(TELEBOT_KNOWN_SERVICES_URLS.split(","), TELEBOT_KNOWN_SERVICES_NAMES.split(","))
except:
    pass
